...
plot(histc(diff(spikes),[0:0.1:10]));
   titlename=['Neuromod cath-tDCS 100uA 30s 4min Ch ' num2str(chan_no)];
...
filename=['Mat_files/Result_figs/Neuromodulation_ctDCS_100uA_30_4_Ch' num2str(chan_no) '.tiff'];
saveas(gcf,filename);
end