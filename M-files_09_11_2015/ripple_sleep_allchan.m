function [hold_s1d_tpre, ripl_pre, hold_s1d_tpost, ripl_post, change]=ripple_sleep_allchan(units,lim,TimeStamps,sleep_ind_pre,sleep_ind_post,data, Fs_lfp, chan_no,sc, freq)
close all
...
%     figure
    ...
    shadedErrorBar([],(sta-mean(sta)),(1*sta_sd),'r',0)
        ...
        shadedErrorBar([],(sta-mean(sta)),(1*sta_sd),'c',0)
    end
    hold on
