function [Change_sws_med Change_spindle_med]=plot_SWS_coherence3_dr5_structunits(TimeStamps1,TimeStamps2,data1,data2, time_pre1,time_post1,units, chan_no, sc, bin_size, space, Fs_lfp, taper, win,dir)
figure
close all
      params.Fs=Fs_lfp;
        params.fpass=[0 20];
