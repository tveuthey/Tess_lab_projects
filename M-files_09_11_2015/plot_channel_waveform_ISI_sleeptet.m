...
function [Change_firing]=plot_channel_waveform_ISI_sleeptet(Waves1,Waves2,TimeStamps1,TimeStamps2,N,units,sleep_ind_pre, sleep_ind_post,Fs_lfp)
close all
for i=1:length(units)
    ...
    %if N==2
        filename= ['C:\Users\dhaks_000\Documents\MATLAB\Dhakshin\Mat_files\raw_data\Reach\T39\Session3\Waveform SC' int2str(N) 'Ch' num2str(chan_no) '.tiff'];
        set(gcf, 'Position', get(0,'Screensize'));
        saveas(gcf,filename);
    %elseif N ==3
