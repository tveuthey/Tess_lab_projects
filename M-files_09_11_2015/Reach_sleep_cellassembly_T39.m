function [Activities_pre Activities_post]=Reach_sleep_cellassembly_T39(TimeStamps1,TimeStamps2, time_pre,time_post,Fs_lfp, bin,units,Patterns,dir,template)
...
count=0;
    for i = 1:length(units)
        ...
        unit=units(i);
        ts1=TimeStamps1{unit}*Fs_lfp;
        ts2=TimeStamps2{unit}*Fs_lfp;
        dN_pre = [];
        dN_post=[];
        tmplen=0;
        ts1atmp2=[];
