...
if exist('Allstreams.streams.LFPs.data')
data = Allstreams.streams.LFPs.data;
Fs_lfp = Allstreams.streams.LFPs.fs;
end
if exist('Allstreams.streams.Wave.data')
wave = Allstreams.streams.Wave.data;
Fs_wave = Allstreams.streams.Wave.fs;
end
...
%saving raw data
outdir = 'C:\Users\dhaks_000\Documents\MATLAB\Dhakshin\Mat_files\raw_data\Reach\T25\ ';
if (~exist(outdir))
    mkdir(outdir);
end
cd (outdir)
