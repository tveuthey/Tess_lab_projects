...
TankName = 'T###'; %change the animal name
numBlocks = 15; %change the number of blocks
cd ('J:\T111 data and analysis\T111 Blocks') %change directory to save things
chan=[1:64]; %number of channels

% see lines 166/167. sometimes adding version number is needed for larger
% files?
