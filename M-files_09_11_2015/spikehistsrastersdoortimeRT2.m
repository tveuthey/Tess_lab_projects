...
block_len=1218;
before_zero=609; % looking 1.2 sec before and after grab time at 508 samples/sec
figure;
chan_no=2;
...
%     [time_axis2]=[time_axis]/Fs_lfp;
    ...
    axh=subplot(5,1,1);
    plot(mean_temp_strobe,'c'); axis([0 1218 -5 5]); set(axh, 'XGrid', 'on');set(gca,'XTick',[0 203 406 609 812 1015 1218]);set(gca,'XTickLabel',{'-1.2','-0.8','-0.4','0','0.4','0.8','1.2'})
    hold on;
    a=axis;
