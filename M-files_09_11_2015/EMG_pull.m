...
TankName='New';
Block_Name='Block-280'
% SortID='R31sort'
filename='data_spikes_lfps_wav_280'
...
%size_lfp=TTX.ParseEvInfoV(0, 0, 1)   % determines channel size
size_semg=length(temp3);
dec_factor=1;
Fs_semg=Fs_semg/dec_factor
for chan_no=1:6;
    disp(chan_no)
    get_chan=chan(chan_no);
    TTX.SetGlobalV('Channel',get_chan);
...
save (['Mat_files/raw_data/New/data_block_280'])
