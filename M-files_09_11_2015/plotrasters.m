...
subplot(3,3,i)
plot(([waves{i}]),'r-');  XLim([0 30]);YLim([-0.0002 0.0002]); set(gca,'XTick',[0 30]);set(gca,'XTickLabel',{'0','1.2'}); set(gca,'YTick',[-0.0002 0 0.0002]);set(gca,'YTickLabel',{'-200','0','200'}); xlabel('msec'); ylabel('microvolt');% title('Unsuccessful')
