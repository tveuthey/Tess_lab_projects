function [Output]=sws_movie2(sleep_ind_pre, sleep_ind_post, data,TimeStamps, chan_no,sc, Fs_lfp)
close all
% clear
...
for n = (plotlen+1):10:length(data2)
