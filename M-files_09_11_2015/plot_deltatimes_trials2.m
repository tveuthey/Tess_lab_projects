...
for i=1:length(units)
    ...
    if sc==2
    filename=['C:\Users\Ganguly Lab\Documents\MATLAB\Tanuj\Mat_files\Result_figs\BMI\S23\2_26_13\S23_Learning_3to8 Ch' num2str(chan_no) '.tiff'];
    else if sc==3
            filename=['C:\Users\Ganguly Lab\Documents\MATLAB\Tanuj\Mat_files\Result_figs\BMI\S23\2_26_13\S23_Learning_3to8 SC_2 Ch' num2str(chan_no) '.tiff'];
        end
    end
