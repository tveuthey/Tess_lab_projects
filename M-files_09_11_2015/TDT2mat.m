...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Line 236 --> change ECoG to LFPs if needed
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 1:length(lStores)
    ...
    switch type
        ...
        case 'Stream'
            if (strcmp('ECoG',name) || strcmp('Wave',name))
            ...
            if ranges_size > 0
                ...
                while nancheck
                    ...
                    warning(sprintf('ReadWavesV returned NaN for %s, attempting step size %.2f', name, step_size));
        ...
        case 'Snip'
            ...
            if ranges_size > 0
                for ff = 1:ranges_size
                    N = TTX.ReadEventsV(MAXEVENTS, name, 0, 0, RANGES(1, ff), RANGES(2, ff), 'ALL');
                    if N > 0
                ...
                N = TTX.ReadEventsV(MAXEVENTS, name, 0, 0, T1, T2, 'ALL');
                if N > 0
