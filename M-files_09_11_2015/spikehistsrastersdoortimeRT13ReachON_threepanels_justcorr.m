...
%     hold off;
    ...
    plot ([(t(1):0.05:t(end))-t(1)],1*PEH_rate/y_max,'r','LineWidth',3);XLim([0 max_ax2]);YLim([0 1]);set(gca,'XTick',[0 f2 f2*2 f2*3 ]);set(gca,'XTickLabel',{'-2','-1','Reach ON','1'},'FontSize',14,'FontWeight','BOLD');set(gca,'YTick',[0 0.5 1 ]);set(gca,'YTickLabel',{'0','','1'},'FontSize',14,'FontWeight','BOLD');set(ax4, 'XGrid', 'on');set(ax4, 'YGrid', 'on');
    hold on;
%     plot
%     ([(t(1):0.05:t(end))-t(1)],1*PEH_rate2/y_max2,'k','LineWidth',3);XLim([0 max_ax2]);YLim([0 1]);set(gca,'XTick',[0 f2 f2*2 f2*3 ]);set(gca,'XTickLabel',{'-2','-1','Reach ON','1'},'FontSize',14,'FontWeight','BOLD');set(gca,'YTick',[0 0.5 1 ]);set(gca,'YTickLabel',{'0','','1'},'FontSize',14,'FontWeight','BOLD');set(ax4, 'XGrid', 'on');set(ax4, 'YGrid', 'on');
    ...
    for lcorr=1:length(corr)
        ...
        subplot(3,1,2)
        plot(rastertics3{lcorr},[0 1]+lcorr,'r','LineWidth',2);plot(doordelta(lcorr),[0 1]+lcorr,'gx');XLim([0 max_ax2]);YLim([0 max_trials]);set(gca,'XTick',[0 1 2 3 ]);set(gca,'XTickLabel',{'-2','-1','Reach ON','1'},'FontSize',14,'FontWeight','BOLD'); %set(gca,'YTickLabel','FontSize',14,'FontWeight','BOLD')%axis([0 2.4 (0+n4) (1+n4)]);%hold off;
        hold on
    end
%     hold on
