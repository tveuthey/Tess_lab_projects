...
%
%
function [points flags] = captureVideoKinematics_old(videoFile,numPoints)
...
while ~ExitFunction
    ...
    title(['Current Point in Frame ',num2str(currentFrame),' of ',num2str(size(vid,4)),': ', num2str(currentPoint),' with ',num2str(length(find(flags))),' flags marked']);
