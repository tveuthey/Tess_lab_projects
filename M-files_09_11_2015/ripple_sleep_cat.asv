function [hold_s1d_tpre, ripl_pre, hold_s1d_tpost, ripl_post, change]=ripple_sleep_cat(unit,lim,TimeStamps,sleep_ind_pre,sleep_ind_post,data, Fs_lfp, chan_no,sc, freq)
close all
...
if freq==1
    t=['Pre-Post SWA full Ch' num2str(unit)];
    
else
    if freq==2
        t=['Pre-Post Spindle full Ch' num2str(unit)];
        
    else
        if freq==3
            t=['Pre-Post Ripple full Ch' num2str(unit)];
...
if sc==2
    if freq==1
        filename=['C:\Users\Ganguly Lab\Documents\MATLAB\Tanuj\Mat_files\Result_figs\BMI\' Session 'Sleep SWA full SC1 Ch' num2str(unit) '.tiff'];
    else
        if freq==2
            filename=['C:\Users\Ganguly Lab\Documents\MATLAB\Tanuj\Mat_files\Result_figs\BMI\' Session 'Sleep Spindle full SC1 Ch' num2str(unit) '.tiff'];
        else
            if freq==3
                filename=['C:\Users\Ganguly Lab\Documents\MATLAB\Tanuj\Mat_files\Result_figs\BMI\' Session 'Sleep Ripple full SC1 Ch' num2str(unit) '.tiff'];
            end
        end
    end
else
    if sc==3
        if freq==1
            filename=['C:\Users\Ganguly Lab\Documents\MATLAB\Tanuj\Mat_files\Result_figs\BMI\' Session 'Sleep SWA full SC2 Ch' num2str(unit) '.tiff'];
        else
            if freq==2
                filename=['C:\Users\Ganguly Lab\Documents\MATLAB\Tanuj\Mat_files\Result_figs\BMI\' Session 'Sleep Spindle full SC2 Ch' num2str(unit) '.tiff'];
            else
                if freq==3
                    filename=['C:\Users\Ganguly Lab\Documents\MATLAB\Tanuj\Mat_files\Result_figs\BMI\' Session 'Sleep Ripple full SC2 Ch' num2str(unit) '.tiff'];
                end
            end
        end
    end
