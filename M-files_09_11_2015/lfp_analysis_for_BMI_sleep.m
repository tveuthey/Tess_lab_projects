...
%     data_LFP=(abs(filter(bt,at,data_LFP))).^2;
    ...
    xlabel('Frequency (Hz)','FontSize',14,'FontWeight','BOLD'); XLim([0 25])
    ylabel('Amplitude','FontSize',14,'FontWeight','BOLD')
    legend('Pre','Post','Location','NorthEast')
    set(gca,'FontSize',14,'FontWeight','BOLD' )
end

filename=['C:\Users\Ganguly Lab\Documents\MATLAB\Tanuj\Mat_files\Result_figs\BMI\S32\5_1_13\Sleep-LFP.tiff'];
