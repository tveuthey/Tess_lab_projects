...
for chan_no_forchew=[chan_no_forchew]
    ...
    for n=1:trials_NO
        ...
        hold on;
        hold_val(n)=mean(sm_power(47:60));
...
clear data_filt1_corr data_filt1_incorr PEH_rate PEH_rate2 y_max rastertics6 rastertics7
y_max=0;
bin_rate=[];
bin_rate2=[];
data_hil_corr=[];
...
filename=['Mat_files/Result_figs/Block346_SC2_Chan' num2str(chan_no) '.tiff'];
