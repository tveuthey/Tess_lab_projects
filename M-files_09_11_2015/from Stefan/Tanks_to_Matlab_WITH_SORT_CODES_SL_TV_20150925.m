...
save_path = 'T131_Tank_Data_Waveclus_sorted'; %this is the folder that will be created for processed blocks
channels = [1:64];
down_samp = 1;
...
for n_block=74%1:num_blocks
    ...
    save([save_name], 'block_name', 'LFP_data', 'LFP_samp_freq', 'wave',...
        ...
        'Spike_filt_data_samp_freq','-v7.3');
