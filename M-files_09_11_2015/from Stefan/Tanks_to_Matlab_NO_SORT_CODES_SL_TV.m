...
tank_name = 'T131';
tank_path = 'J:\T131 data and analysis\T131 Blocks\';
save_path = 'T131_Tank_Data_Waveclus';
channels = [1:64];
down_samp = 1;
block_path = 'J:\T131 data and analysis\T131';
...
for n_block=1:num_blocks
    ...
    for n_channel=1:length(channels)
        ...
        for n_unit=1:5
            N{n_channel,n_unit} = TT.ReadEventsV(max_number_spikes, 'eNeu', n_channel, n_unit-1, 0, 0, 'ALL');
    ...
    save([save_name], 'block_name', 'LFP_data', 'LFP_samp_freq', 'wave', 'Spike_times', 'Spike_waves', 'Spike_filt_data');
