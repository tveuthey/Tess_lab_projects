function [Output]=plot_learning_PSTHs_BMI(TimeStamps, chan_no,data,wave,start_trial, start_pulse2, Fs_lfp,Waves,N,sc,bin_size,space)
close all;
...
%     ylabel('Count','FontSize',14,'FontWeight','BOLD');
    ...
    legend('First 1/3rd trials','Second 1/3rd trials','Last 1/3rd trials','Location','NorthWest')
               filename=['C:\Users\Ganguly Lab\Documents\MATLAB\Tanuj\Mat_files\Result_figs\BMI\T10\05_22_13\Task Every Third Trial PSTH Ch' num2str(chan_no) '.tiff'];
