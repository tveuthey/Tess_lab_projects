    ...
    if sc==2
        if freq==1
            ...
            if freq==2
                ...
                if freq==3
                    filename=['C:\Users\dhaks_000\Documents\MATLAB\Dhakshin\Mat_files\raw_data\Reach\' Session 'Sleep Ripple post-' Dur 'SC1 Ch' num2str(unit) '.tiff'];
                end
            end
        end
    else
        if sc==3
            if freq==1
                ...
                if freq==2
                    ...
                    if freq==3
                        filename=['C:\Users\dhaks_000\Documents\MATLAB\Dhakshin\Mat_files\raw_data\Reach\' Session 'Sleep Ripple post-' Dur 'SC2 Ch' num2str(unit) '.tiff'];
                    end
                end
            end
        end
